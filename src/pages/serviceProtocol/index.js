    ...
    return (
      <View className='serviceProtocol-page'>
        <View className='at-article'>
          ...
          <View className='at-article__p'>
            甲方、乙方及惠租平台关系说明：【甲方】指的是通过惠租平台入驻成为惠租平台的商家，自愿签署《惠租租赁服务协议》，且已阅览并同意本协议所有条款，认可本协议的法律效力。【乙方】乙方指的是通过惠租平台下单租用甲方商品的租户。乙方有权选择是否签署《惠租租赁服务协议》。乙方在惠租平台下单支付后，即代表阅览并同意本协议所有条款，认可本协议的法律效力。
          </View>
          <View className='at-article__p'>
            甲方依据本《惠租租赁服务协议》（“本协议”）的约定通过惠租（“平台”）为乙方提供租赁服务，请乙方务必审慎阅读本协议，乙方下单支付后，即视为乙方已经充分阅读并接受本协议全部条款，本协议立即生效且具有法律效力。
          </View>
          <View className='at-article__h3'>第一条 关于设备</View>
          <View className='at-article__p'>
            1.1 平台的设备由符合甲方向乙方提供，双方一致确认惠租平台注册地为合同履行地。
          </View>
          <View className='at-article__p'>
          ...
          <View className='at-article__p'>
            12.2当乙方注册惠租以及在使用平台租赁服务时，乙方须向提供个人信息。惠租收集个人信息的目的是为乙方提供尽可能多的个人服务以及风险评估，从而为乙方提供免押租赁服务，在此过程中，平台不会泄露个人信息。
          </View>
          <View className='at-article__p'>
            12.3惠租不会在未经合法用户授权时，公开、编辑或透露其个人信息及保存在惠租中的非公开内容，除非有下列情况：
          </View>
          <View className='at-article__p'>
            （1）事先获得用户的明确授权；
          </View>
          ...
          <View className='at-article__p'>
            12.4为提升服务的质量，惠租可能会与第三方合作共同向用户提供相关服务，此类合作可能需要包括但不限于用户数据与第三方用户数据的互通。在此情况下，乙方知晓并同意如该第三方同意承担与惠租同等的保护用户隐私的责任，则惠租有权将乙方的注册资料等提供给该第三方，并与第三方约定用户数据仅为双方合作之目的使用；并且惠租将对该等第三方使用乙方数据的行为进行监督和管理，尽一切合理努力保护乙方个人信息的安全性。
          </View>
          <View className='at-article__p'>
            12.5惠租可以向乙方注册的电子邮箱、手机号码发送服务所必须的商业信息。
          </View>
